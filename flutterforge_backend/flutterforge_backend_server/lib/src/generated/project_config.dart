...
import 'package:flutterforge_backend_server/src/generated/protocol.dart' as _i6;
...
abstract class ProjectConfig
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      'projectName': projectName,
      'platforms': platforms.toJson(),
      if (figma != null) 'figma': figma?.toJsonForProtocol(),
      if (postman != null) 'postman': postman?.toJsonForProtocol(),
